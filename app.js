...
const TASK_EVAL_HINTS = {
  ...
  labor: "1 — дуже швидка дія; 2 — невеликий обсяг; 3 — нормальна службова задача; 4 — відчутна підготовка й координація; 5 — великий обсяг роботи або складний супровід.",

  importance: "1 — локальне питання; 2 — корисно для окремого напрямку; 3 — важливо для відділу; 4 — значимо для кількох людей/процесу; 5 — критично для керівництва, кількох відділів або ключового рішення.",

  urgency: "1 — був запас часу; 2 — помірний строк; 3 — треба було вкластися в дедлайн; 4 — відчутний часовий тиск; 5 — дуже терміново, сьогодні на сьогодні / нарада / перевірка.",

  result: "1 — мінімальний або проміжний ефект; 2 — корисний, але обмежений результат; 3 — повний очікуваний результат; 4 — сильний практичний ефект; 5 — дуже сильний результат із відчутним впливом або зняттям ризику."
...
function openTaskEvaluation(taskId){
  ...
  showSheet(`Оцінка задачі`, `
    ...
    <div class="item" style="cursor:default; margin-top:10px;">
      <div class="name">Міні-шпаргалка 1 / 2 / 3 / 4 / 5</div>
      <div class="hint">
        <b>1</b> — дуже невелика задача, швидка дія, мінімальний вплив.<br/>
        <b>2</b> — невелика робоча задача, вже є користь, але без значного масштабу.<br/>
        <b>3</b> — нормальний робочий рівень, повноцінна службова задача.<br/>
        <b>4</b> — сильна задача: помітний обсяг, важливість або часовий тиск.<br/>
        <b>5</b> — справді вагома задача: велика, критична, дуже термінова або з сильним результатом.
      </div>
    </div>
    <div class="actions" style="margin-top:14px;">
  ...
  showSheet("Довідка: як оцінювати задачі", `
    ...
    <div class="item" style="cursor:default;">
      ...
      <div class="hint">
        ...
        <b>2 бали</b> — невелика задача: уже треба було трохи підготуватися або щось зібрати, але обсяг ще невеликий.<br/>
        <b>3 бали</b> — помірний обсяг: треба було зібрати дані, узгодити, підготувати матеріал, зробити кілька кроків.<br/>
        <b>4 бали</b> — великий обсяг: серйозна підготовка, багато матеріалів, кілька погоджень або суттєва координація.<br/>
    ...
    <div class="item" style="cursor:default;">
      ...
      <div class="hint">
        ...
        <b>2 бали</b> — корисно для окремого працівника, невеликого напрямку або частини процесу.<br/>
        <b>3 бали</b> — важливо для роботи відділу, впливає на процес або строки, але без критичних наслідків.<br/>
        <b>4 бали</b> — дуже важливо: впливає на кілька людей, етап роботи, підготовку до наради чи рішення.<br/>
    ...
    <div class="item" style="cursor:default;">
      ...
      <div class="hint">
        ...
        <b>2 бали</b> — строк є, але він комфортний, без відчутного тиску.<br/>
        <b>3 бали</b> — задачу треба було зробити в строк, без великого запасу, але без авралу.<br/>
        <b>4 бали</b> — часовий тиск уже відчутний: мало часу, кілька паралельних дій, треба було прискорюватися.<br/>
    ...
    <div class="item" style="cursor:default;">
      ...
      <div class="hint">
        ...
        <b>2 бали</b> — є корисний результат, але він обмежений або допоміжний.<br/>
        <b>3 бали</b> — повний нормальний результат: задачу закрито, очікуваний результат отримано.<br/>
        <b>4 бали</b> — сильний практичний результат: відчутно допоміг роботі, прискорив процес або покращив рішення.<br/>
    ...
    <div class="item" style="cursor:default;">
      ...
      <div class="hint">
        ...
        <b>Практичне правило:</b><br/>
        1–2 — дрібні та локальні задачі.<br/>
        3 — стандартна повноцінна службова задача.<br/>
        4 — сильна задача з помітною вагою.<br/>
        5 — рідкісна, справді велика або критична задача.<br/><br/>
    ...
    <div class="item" style="cursor:default;">
      ...
      <div class="hint">
        <b>1</b> — мінімум зусиль / локально / без великого ефекту.<br/>
        <b>2</b> — невелика, але вже повноцінна корисна дія.<br/>
        <b>3</b> — стандартна робоча норма, “хороша звичайна задача”.<br/>
        <b>4</b> — сильна задача: важлива, трудомістка, термінова або з хорошим результатом.<br/>
        <b>5</b> — винятково вагома задача: велика, критична або з дуже сильним впливом.
      </div>
    </div>
